...
(function () {
  ...
  function init() {
    ...
    // Set custom dialog type 5
    var $dialog_5 = widgets.createCustomDialog({
      selector: "#dialog-5",
      full_width_button: true
    });
    $("#dialog-btn-5").on("click", function () {
      $dialog_5.dialog("open");
    });

    // Set custom dialog type 6
    var $dialog_6 = widgets.createCustomDialog({
      selector: "#dialog-6",
      full_width_button: true
    });
    $("#dialog-btn-6").on("click", function () {
      $dialog_6.dialog("open");
    });

    // Set custom dialog type 7
    var $dialog_7 = widgets.createCustomDialog({
      selector: "#dialog-7",
      full_width_button: true
    });
    $("#dialog-btn-7").on("click", function () {
      $dialog_7.dialog("open");
    });

    // Set custom dialog type 8
    var $dialog_8 = widgets.createCustomDialog({
      selector: "#dialog-8",
      full_width_button: true
    });
    $("#dialog-btn-8").on("click", function () {
      $dialog_8.dialog("open");
    });

    // Set custom dialog type 9
    var $dialog_9 = widgets.createCustomDialog({
      selector: "#dialog-9",
      full_width_button: true
    });
    $("#dialog-btn-9").on("click", function () {
      $dialog_9.dialog("open");
    });

    // Set custom dialog type 10
    var $dialog_10 = widgets.createCustomDialog({
      selector: "#dialog-10",
      full_width_button: true
    });
    $("#dialog-btn-10").on("click", function () {
